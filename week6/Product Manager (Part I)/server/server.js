...
//middleware that allows us to read JSON objects sent in the client's request
app.use(express.json(), express.urlencoded({ extended: true })); //middleware that allows us to read JSON objects with strings and arrays in the client's request
